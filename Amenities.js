...
//     { icon: 'restaurant', name: 'Restaurant', description: 'Fine dining cuisine' },
//     { icon: 'fitness', name: 'Fitness Center', description: '24/7 gym access' },
//     { icon: 'water', name: 'Swimming Pool', description: 'Outdoor heated pool' },
//   ];
...
//           <Ionicons name={amenity.icon} size={24} color="#d4af37" />
